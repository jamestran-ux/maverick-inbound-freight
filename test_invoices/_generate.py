...
def main():
    ...
    # Test #5: Drayage Excel — 5 invoices in one file (bulk upload test)
    _build_excel(
        path=os.path.join(HERE, "TEST_Bulk_Invoices.xlsx"),
        rows=[
            {"Invoice #": "ACS-INV-99001", "Invoice Date": "2026-05-17",
             "Carrier": "Atlantic Container Services", "FB# / Load ID": "ACS25051701",
             "Container #": "HLBU4421890", "BOL/MBL #": "HLCUEC123456", "Equipment": "40HC",
             "Origin": "Charleston — Wando Welch", "Destination": "NewAge Monee IL",
             "Rate Type": "DRY", "Base Rate": 1320.00, "Linehaul (USD)": 1320.00,
             "FSC %": 0.18, "FSC (USD)": 237.60, "Accessorial Detail": "Chassis day x 2",
             "Grand Total (USD)": 1617.60, "Currency": "USD", "Terms": "Net 30"},
            {"Invoice #": "PCD-INV-99002", "Invoice Date": "2026-05-17",
             "Carrier": "Pacific Coastline Drayage", "FB# / Load ID": "PCD25051702",
             "Container #": "OOLU9912345", "BOL/MBL #": "OOLU2050001234", "Equipment": "40HC",
             "Origin": "Long Beach — Pier T", "Destination": "NewAge Perris CA",
             "Rate Type": "DRY", "Base Rate": 495.00, "Linehaul (USD)": 495.00,
             "FSC %": 0.22, "FSC (USD)": 108.90, "Accessorial Detail": "Pier Pass; Chassis day",
             "Grand Total (USD)": 663.90, "Currency": "USD", "Terms": "Net 30"},
            {"Invoice #": "CDS-INV-99002", "Invoice Date": "2026-05-17",
             "Carrier": "Continental Drayage Solutions", "FB# / Load ID": "CDS25051703",
             "Container #": "MSCU7708219", "BOL/MBL #": "MEDUSV80290002", "Equipment": "40HC",
             "Origin": "Savannah — Garden City", "Destination": "NewAge Monee IL",
             "Rate Type": "DRY", "Base Rate": 1450.00, "Linehaul (USD)": 1450.00,
             "FSC %": 0.18, "FSC (USD)": 261.00, "Accessorial Detail": "Chassis day x 3",
             "Grand Total (USD)": 1801.00, "Currency": "USD", "Terms": "Net 45"},
            {"Invoice #": "PCD-INV-99005", "Invoice Date": "2026-05-18",
             "Carrier": "Pacific Coastline Drayage", "FB# / Load ID": "PCD25051803",
             "Container #": "ONEU3344556", "BOL/MBL #": "ONEYSZPG60270005", "Equipment": "40HC",
             "Origin": "Long Beach — Pier J", "Destination": "NewAge Perris CA",
             "Rate Type": "DRY", "Base Rate": 475.00, "Linehaul (USD)": 475.00,
             "FSC %": 0.22, "FSC (USD)": 104.50, "Accessorial Detail": "Pier Pass",
             "Grand Total (USD)": 609.50, "Currency": "USD", "Terms": "Net 30"},
            {"Invoice #": "ACS-INV-99003", "Invoice Date": "2026-05-18",
             "Carrier": "Atlantic Container Services", "FB# / Load ID": "ACS25051804",
             "Container #": "HLBU2299881", "BOL/MBL #": "HLCUEC123789", "Equipment": "40HC",
             "Origin": "Charleston — Wando Welch", "Destination": "NewAge Monee IL",
             "Rate Type": "DRY", "Base Rate": 1280.00, "Linehaul (USD)": 1280.00,
             "FSC %": 0.18, "FSC (USD)": 230.40, "Accessorial Detail": "Chassis day",
             "Grand Total (USD)": 1555.40, "Currency": "USD", "Terms": "Net 30"},
        ],
    )

    # Test #6: 5 additional drayage PDFs for the "5 files at once" multi-upload test
    drayage_pdfs = [
        # PCD #3 — Long Beach normal lane
        dict(path="TEST_PCD-INV-99003.pdf", company="PACIFIC COASTLINE DRAYAGE INC.",
             addr="2200 E. Anaheim Street, Long Beach, CA 90804",
             contact="Tel (562) 555-0190 · AP@pacificcoastlinedrayage.com",
             invoice_no="PCD-INV-99003", date="2026-05-19", terms="Net 30",
             fb_no="PCD25051901", container="ONEU4455667", bol="ONEYSZPG60270010",
             origin="Long Beach — Pier T", dest="NewAge Perris CA", equip="40HC",
             linehaul=495.00, fsc_pct=0.22, fsc_amount=108.90,
             accessorials=[("Pier Pass / Clean Truck Fee", 30.00)],
             grand_total=633.90, msa="PCD-NA-MSA-2025-014"),
        # PCD #4 — same lane, slight rate variance (planted audit candidate)
        dict(path="TEST_PCD-INV-99004.pdf", company="PACIFIC COASTLINE DRAYAGE INC.",
             addr="2200 E. Anaheim Street, Long Beach, CA 90804",
             contact="Tel (562) 555-0190 · AP@pacificcoastlinedrayage.com",
             invoice_no="PCD-INV-99004", date="2026-05-19", terms="Net 30",
             fb_no="PCD25051902", container="ONEU5566778", bol="ONEYSZPG60270011",
             origin="Long Beach — Pier T", dest="NewAge Perris CA", equip="40HC",
             linehaul=545.00, fsc_pct=0.22, fsc_amount=119.90,
             accessorials=[("Pier Pass / Clean Truck Fee", 30.00),
                           ("Detention 2hr", 90.00)],
             grand_total=784.90, msa="PCD-NA-MSA-2025-014"),
        # CDS — Savannah → Monee, lighter weight
        dict(path="TEST_CDS-INV-99003.pdf", company="CONTINENTAL DRAYAGE SOLUTIONS",
             addr="980 Industrial Pkwy, Savannah, GA 31408",
             contact="Tel (912) 555-0181 · AP@continentaldrayage.com",
             invoice_no="CDS-INV-99003", date="2026-05-19", terms="Net 45",
             fb_no="CDS25051901", container="MSCU8899001", bol="MEDUSV80290010",
             origin="Savannah — Garden City Terminal", dest="NewAge Monee IL", equip="40HC",
             linehaul=1450.00, fsc_pct=0.18, fsc_amount=261.00,
             accessorials=[("Chassis Day x 2", 60.00)],
             grand_total=1771.00, msa="CDS-NA-MSA-2025-009"),
        # ACS — Charleston → Monee, clean
        dict(path="TEST_ACS-INV-99004.pdf", company="ATLANTIC CONTAINER SERVICES",
             addr="510 Concord Pkwy N, Concord, NC 28027",
             contact="Tel (704) 555-0210 · AP@atlanticcontainer.com",
             invoice_no="ACS-INV-99004", date="2026-05-19", terms="Net 30",
             fb_no="ACS25051901", container="HLBU3344117", bol="HLCUEC123890",
             origin="Charleston — Wando Welch", dest="NewAge Monee IL", equip="40HC",
             linehaul=1280.00, fsc_pct=0.18, fsc_amount=230.40,
             accessorials=[("Chassis Day", 30.00)],
             grand_total=1540.40, msa="ACS-NA-MSA-2025-007"),
        # PCD #6 — duplicate-test candidate (same invoice # as #99003 but re-run)
        dict(path="TEST_PCD-INV-99006.pdf", company="PACIFIC COASTLINE DRAYAGE INC.",
             addr="2200 E. Anaheim Street, Long Beach, CA 90804",
             contact="Tel (562) 555-0190 · AP@pacificcoastlinedrayage.com",
             invoice_no="PCD-INV-99006", date="2026-05-19", terms="Net 30",
             fb_no="PCD25051903", container="ONEU6677889", bol="ONEYSZPG60270012",
             origin="Long Beach — Pier T", dest="NewAge Perris CA", equip="40HC",
             linehaul=495.00, fsc_pct=0.22, fsc_amount=108.90,
             accessorials=[("Pier Pass / Clean Truck Fee", 30.00),
                           ("TONU (no dispatch log)", 295.00)],  # ⚠ planted finding
             grand_total=928.90, msa="PCD-NA-MSA-2025-014"),
    ]
    for d in drayage_pdfs:
        _build_pdf(
            path=os.path.join(HERE, d["path"]),
            header_company=d["company"], header_addr=d["addr"], header_contact=d["contact"],
            invoice_no=d["invoice_no"], invoice_date=d["date"], terms=d["terms"],
            fb_no=d["fb_no"], container_no=d["container"], bol=d["bol"],
            origin=d["origin"], dest=d["dest"], equip=d["equip"],
            linehaul=d["linehaul"], fsc_pct=d["fsc_pct"], fsc_amount=d["fsc_amount"],
            accessorials=d["accessorials"], grand_total=d["grand_total"], msa_ref=d["msa"],
        )

    # Test #7: 5 additional customs PDFs for the "5 customs files at once" test
    customs_pdfs = [
        dict(path="TEST_LI-99003_customs.pdf", inv="LI-99003", date="2026-05-19",
             period="2026-05-04 to 2026-05-19", terms="Net 30",
             entries=[
                {"entry": "LI-99003-A", "container": "ONEU4455667", "po": "PO-NA-25-04601",
                 "value": 38500.00, "hts": "9403.20.0090", "duty_rate": "0.0%",
                 "sec301": "25%", "sec232": "—",
                 "duty": 9625.00, "mpf": 245.00, "hmf": 49.13,
                 "brokerage": 175.00, "disbursement": 65.00, "isf": 35.00},
             ], grand_total=10194.13),
        dict(path="TEST_LI-99004_customs.pdf", inv="LI-99004", date="2026-05-19",
             period="2026-05-04 to 2026-05-19", terms="Net 30",
             entries=[
                {"entry": "LI-99004-A", "container": "MSCU8899001", "po": "PO-NA-25-04612",
                 "value": 67200.00, "hts": "7321.11.6000", "duty_rate": "5.7%",
                 "sec301": "25%", "sec232": "—",
                 "duty": 20631.60, "mpf": 435.00, "hmf": 85.71,
                 "brokerage": 225.00, "disbursement": 75.00, "isf": 35.00},
             ], grand_total=21487.31),  # > $50k via duty stack? No — keep under to test no-audit path
        dict(path="TEST_LI-99005_customs.pdf", inv="LI-99005", date="2026-05-19",
             period="2026-05-04 to 2026-05-19", terms="Net 30",
             entries=[  # Two-entry broker invoice — exceeds $50k → audit fires
                {"entry": "LI-99005-A", "container": "HLBU3344117", "po": "PO-NA-25-04623",
                 "value": 142000.00, "hts": "9403.20.0090", "duty_rate": "0.0%",
                 "sec301": "25%", "sec232": "—",
                 "duty": 35500.00, "mpf": 485.00, "hmf": 181.16,
                 "brokerage": 285.00, "disbursement": 95.00, "isf": 35.00},
                {"entry": "LI-99005-B", "container": "ONEU6677889", "po": "PO-NA-25-04634",
                 "value": 92500.00, "hts": "7308.30.5050", "duty_rate": "0.0%",
                 "sec301": "25%", "sec232": "50%",
                 "duty": 69375.00, "mpf": 538.40, "hmf": 117.99,
                 "brokerage": 285.00, "disbursement": 95.00, "isf": 35.00,
                 "notes": "STEEL — Sec 232"},
             ], grand_total=107107.55),
        dict(path="TEST_LI-99006_customs.pdf", inv="LI-99006", date="2026-05-19",
             period="2026-05-04 to 2026-05-19", terms="Net 30",
             entries=[
                {"entry": "LI-99006-A", "container": "ONEU5566778", "po": "PO-NA-25-04645",
                 "value": 28900.00, "hts": "9403.20.0090", "duty_rate": "0.0%",
                 "sec301": "25%", "sec232": "—",
                 "duty": 7225.00, "mpf": 185.00, "hmf": 36.89,
                 "brokerage": 175.00, "disbursement": 65.00, "isf": 35.00},
             ], grand_total=7721.89),
        dict(path="TEST_LI-99007_customs.pdf", inv="LI-99007", date="2026-05-19",
             period="2026-05-04 to 2026-05-19", terms="Net 30",
             entries=[  # Big single entry — audit fires
                {"entry": "LI-99007-A", "container": "HLBU2299881", "po": "PO-NA-25-04656",
                 "value": 215000.00, "hts": "9403.20.0090", "duty_rate": "0.0%",
                 "sec301": "25%", "sec232": "—",
                 "duty": 53750.00, "mpf": 538.40, "hmf": 274.25,
                 "brokerage": 285.00, "disbursement": 95.00, "isf": 35.00},
             ], grand_total=54977.65),
    ]
    for c in customs_pdfs:
        _build_customs_pdf(
            path=os.path.join(HERE, c["path"]),
            invoice_no=c["inv"], invoice_date=c["date"],
            period=c["period"], terms=c["terms"],
            entries=c["entries"], grand_total=c["grand_total"],
        )
